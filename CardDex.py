...
botaover = customtkinter.CTkButton(frame_ver, text="Ver lista", command=lambda:CardDexTools.ver_file(ver_nome, label_resultadover))
...
newcarta = customtkinter.CTkEntry(frame_adicexname, placeholder_text="Nome")
newcarta.pack(side="left", pady=10)
newtipo = customtkinter.CTkEntry(frame_adicexname, placeholder_text="Tipo")
newtipo.pack(side="right", pady=10)
btnadcnomeex = customtkinter.CTkButton(frame_adicexname, text="Adicionar", command=lambda:CardDexTools.add_nomesetipo(ver_nomee, newcarta, newtipo))
...
newcartaa = customtkinter.CTkEntry(frame_adcnometel, placeholder_text="Nome")
newcartaa.pack(side="left", pady=10)
newtipoo = customtkinter.CTkEntry(frame_adcnometel, placeholder_text="Tipo")
newtipoo.pack(side="right", pady=10)
btnadcnmtl = customtkinter.CTkButton(frame_adcnometel, text="Adicionar", command=lambda:CardDexTools.add_nomesetipo(newadclis, newcartaa, newtipoo))
...
btnreml = customtkinter.CTkButton(frame_remov_list, text="Remover Lista", command=lambda:CardDexTools.elim_file(newremovli, label_resultrem))
...
newremovcarta = customtkinter.CTkEntry(frame_remov_con_li, placeholder_text="Nome da carta...")
newremovcarta.pack(pady=10)
btnremovconli = customtkinter.CTkButton(frame_remov_con_li, text="Remover Carta", command=lambda:CardDexTools.remover_carta(newremovcon, newremovcarta))
